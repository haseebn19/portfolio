...
function AboutMe() {
  ...
  return (
    <div>
      ...
      <p>
        <a href="https://www.linkedin.com/in/haseebn/" target="_blank" rel="noopener noreferrer">LinkedIn</a> |
        <a href="mailto:haseebniazi19@outlook.com" target="_blank" rel="noopener noreferrer">Email</a>
      </p>
    </div>
  );
}
